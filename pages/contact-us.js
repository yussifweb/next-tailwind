    ...
    return (
        <Layout>
            ...
            <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                ...
                <iframe width="100%" height="100%" title="map" className="absolute inset-0" frameBorder="0" marginHeight="0" marginWidth="0"
                ...
                <div className="relative mb-4">
                    ...
                    <input type="text" id="name" name="name" className="w-full bg-gray-800 rounded border border-gray-700 
                ...
                <div className="relative mb-4">
                    ...
                    <input type="email" id="email" name="email" className="w-full bg-gray-800 rounded border 
